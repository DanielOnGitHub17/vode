...
function initializeSpeechRecognition() {
    ...
    window.recognition.onerror = (event) => {
        if (window.aiSpeaking) return console.log("AI speaking can't handle");
    ...
    window.recognition.onend = () => {
        if (window.aiSpeaking) return console.log("AI speaking can't restart");
        // Restart recognition except on AI speaking
        try {
